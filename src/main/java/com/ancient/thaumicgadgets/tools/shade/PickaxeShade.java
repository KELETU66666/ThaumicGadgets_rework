 ...
 public class PickaxeShade
   ...
   public PickaxeShade(String name, Item.ToolMaterial material, int repairCount, int repairCooldown, float damage, float speed) {
...
/* 41 */       if (CheckTime(stack, world, 12516L, 24000L)) {
...
/* Location:              C:\Users\戴尔\Desktop\code\Thaumic_Gadgets_1.12.2_0.1.6_tb.26.jar!\com\ancient\thaumicgadgets\tools\shade\PickaxeShade.class
