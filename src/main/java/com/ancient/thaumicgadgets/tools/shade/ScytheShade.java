   ...
   implements IItemAutoRepair
 {
   ...
   public ScytheShade(String name, Item.ToolMaterial material, int repairCount, int repairCooldown, float damage, float speed, int xSize, int ySize, int zSize) {
/* 29 */     super(name, material, xSize, ySize, zSize);
...
/* Location:              C:\Users\戴尔\Desktop\code\Thaumic_Gadgets_1.12.2_0.1.6_tb.26.jar!\com\ancient\thaumicgadgets\tools\shade\ScytheShade.class
