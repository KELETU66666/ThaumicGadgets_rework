...
public class ModelPrimordialArmor extends ModelBiped
{
	...
	{
		super(((ItemArmor)stack.getItem()).armorType== EntityEquipmentSlot.FEET ?.3125f:.0625f, 0, 128, 64);
		float scale = ((ItemArmor)stack.getItem()).armorType==EntityEquipmentSlot.FEET?.3125f:.0625f;
