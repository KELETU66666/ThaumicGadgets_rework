...
public class TileRenderCobbleGenUp extends TileEntitySpecialRenderer<TileEntityExtruderUp> {
    private float timer = 0.0F;
    private static final EntityItem modeIndicator = new EntityItem((Minecraft.getMinecraft()).world, 0.0D, 0.0D, 0.0D);

    public void renderTileEntityAt(TileEntityExtruderUp tile, double x, double y, double z) {
        GL11.glPushMatrix();
        ...
        this.bindTexture(new ResourceLocation("textures/blocks/obsidian.png"));
